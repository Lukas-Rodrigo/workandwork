...
public class TecnicoResource {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<TecnicoDTO> update(@RequestBody @Valid TecnicoDTO dadosTecnico, @PathVariable Integer id) {
        Tecnico tecnico = tecnicoService.update(id, dadosTecnico);
